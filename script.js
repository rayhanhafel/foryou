...
document.querySelector(".tombol").addEventListener('click', function () {
  Swal.fire("Hallo Pacarkuu!", "Aku ada pertanyaan nih buat kamu sayang", "question").then(function () {
    Swal.fire("Jawab yang jujur loh ya!").then(function () {
      Swal.fire("Awas aja kalau kamu bohong", "", "error").then(function () {
        ...
        const {
          ...
          const pertanyaan = Swal.fire({
            title: `${nama} kamu sayang ga sama ${sender}?`,
            showDenyButton: true,
            ...
            if (result.isConfirmed) {
              Swal.fire(`${sender} juga sayang banget sama ${nama}`).then(function () {
                Swal.fire({
                  ...
                  val = e.value
                  Swal.fire(`Makasih yah udah sayang sama ${sender} ${val}%`).then(function () {
                    Swal.fire({
                      ...
                      /* Read more about isConfirmed, isDenied below */
                      if (result.isConfirmed) {
                        Swal.fire(`Huhu iyaa ${sender} juga kangen ${nama} , makasihhh yaa`).then(function () {
